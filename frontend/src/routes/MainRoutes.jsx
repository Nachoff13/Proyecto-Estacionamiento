...
const HistorialCalificacion = Loadable(lazy(() => import('pages/home/calificacion/historial-calificacion')));
// ==============================|| MAIN ROUTING ||============================== //
...
const MainRoutes = {
  ...
  children: [
    ...
    {
      path: 'historial-calificacion',
      element: <HistorialCalificacion />
    },
  ]
};
